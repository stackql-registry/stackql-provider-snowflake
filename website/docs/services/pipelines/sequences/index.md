...
Creates, updates, deletes, gets or lists a <code>sequences</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="sequences" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="snowflake.pipelines.sequences" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Name of the sequence (pattern: <code>^"(&#91;^"&#93;|"")+"|&#91;a-zA-Z_&#93;&#91;a-zA-Z0-9_$&#93;*$</code>)</td>
</tr>
<tr>
    <td><CopyableCode code="database_name" /></td>
    <td><code>string</code></td>
    <td>Database in which the sequence is stored (pattern: <code>^"(&#91;^"&#93;|"")+"|&#91;a-zA-Z_&#93;&#91;a-zA-Z0-9_$&#93;*$</code>)</td>
</tr>
<tr>
    <td><CopyableCode code="schema_name" /></td>
    <td><code>string</code></td>
    <td>Schema in which the sequence is stored (pattern: <code>^"(&#91;^"&#93;|"")+"|&#91;a-zA-Z_&#93;&#91;a-zA-Z0-9_$&#93;*$</code>)</td>
</tr>
<tr>
    <td><CopyableCode code="comment" /></td>
    <td><code>string</code></td>
    <td>Comment for the sequence</td>
</tr>
<tr>
    <td><CopyableCode code="created_on" /></td>
    <td><code>string (date-time)</code></td>
    <td>Date and time when the sequence was created.</td>
</tr>
<tr>
    <td><CopyableCode code="increment" /></td>
    <td><code>integer (int64)</code></td>
    <td>Step interval of the sequence</td>
</tr>
<tr>
    <td><CopyableCode code="ordered" /></td>
    <td><code>boolean</code></td>
    <td>Whether or not the values are generated in increasing or decreasing order</td>
</tr>
<tr>
    <td><CopyableCode code="owner" /></td>
    <td><code>string</code></td>
    <td>Role that owns the sequence (pattern: <code>^"(&#91;^"&#93;|"")+"|&#91;a-zA-Z_&#93;&#91;a-zA-Z0-9_$&#93;*$</code>)</td>
</tr>
<tr>
    <td><CopyableCode code="owner_role_type" /></td>
    <td><code>string</code></td>
    <td>The type of role that owns the sequence</td>
</tr>
<tr>
    <td><CopyableCode code="start" /></td>
    <td><code>integer (int64)</code></td>
    <td>First value returned by the sequence</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-createMode"><code>createMode</code></a>, <a href="#parameter-targetDatabase"><code>targetDatabase</code></a>, <a href="#parameter-targetSchema"><code>targetSchema</code></a></td>
    <td>Create a new sequence by cloning from the specified resource</td>
</tr>
<tr>
    ...
    <td>Rename a sequence with a new identifier</td>
</tr>
</tbody>
</table>
...
- name: sequences
  props:
    - name: database_name
      value: "{{ database_name }}"
      description: Required parameter for the sequences resource.
    - name: schema_name
      value: "{{ schema_name }}"
      description: Required parameter for the sequences resource.
    - name: endpoint
...
```sql
EXEC snowflake.pipelines.sequences.rename 
@database_name='{{ database_name }}' --required, 
@schema_name='{{ schema_name }}' --required, 
@name='{{ name }}' --required, 
