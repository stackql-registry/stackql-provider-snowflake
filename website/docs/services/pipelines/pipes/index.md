...
<tr><td><b>Id</b></td><td><CopyableCode code="snowflake.pipelines.pipes" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>COPY INTO &lt;table&gt; statement used to load data from queued files into a Snowflake table. This statement serves as the text/definition for the pipe and is displayed in the SHOW PIPES output (pattern: <code>(?i)^COPY INTO .*</code>)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-database_name"><code>database_name</code></a>, <a href="#parameter-schema_name"><code>schema_name</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-copy_statement"><code>copy_statement</code></a></td>
...
owner_role_type,
pattern
FROM snowflake.pipelines.pipes
...
```sql
INSERT INTO snowflake.pipelines.pipes (
name,
comment,
auto_ingest,
error_integration,
...
```sql
DELETE FROM snowflake.pipelines.pipes
WHERE database_name = '{{ database_name }}' --required
AND schema_name = '{{ schema_name }}' --required
AND name = '{{ name }}' --required
AND endpoint = '{{ endpoint }}' --required
...
```sql
EXEC snowflake.pipelines.pipes.refresh 
