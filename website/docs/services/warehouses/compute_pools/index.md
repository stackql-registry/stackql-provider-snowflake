...
<tr><td><b>Id</b></td><td><CopyableCode code="snowflake.warehouses.compute_pools" /></td></tr>
</tbody></table>
...
<tr>
    <td><CopyableCode code="desired_nodes" /></td>
    <td><code>integer</code></td>
    <td>Number of nodes to maintain on the compute pool</td>
</tr>
<tr>
    <td><CopyableCode code="desired_nodes_expire_after" /></td>
    <td><code>string (date-time)</code></td>
    <td>Time after which the desired nodes on the compute pool will expire.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Instance family for the compute pool. Use the /api/v2/compute-pools/instance-families endpoint to retrieve available values.</td>
</tr>
<tr>
...
<tr>
    <td><CopyableCode code="optimize_for_capacity" /></td>
    <td><code>boolean</code></td>
    <td>Whether the compute pool is optimized for capacity.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The name of the placement group on the compute pool.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Current state of the compute pool. Possible values include UNKNOWN, STARTING, IDLE, ACTIVE, STOPPING, SUSPENDED, and RESIZING. (UNKNOWN, STARTING, IDLE, ACTIVE, STOPPING, SUSPENDED, RESIZING)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-endpoint"><code>endpoint</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-instance_family"><code>instance_family</code></a>, <a href="#parameter-min_nodes"><code>min_nodes</code></a>, <a href="#parameter-max_nodes"><code>max_nodes</code></a></td>
...
<tr>
    <td><a href="#stop_all_services"><CopyableCode code="stop_all_services" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-name"><code>name</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td></td>
...
<Tabs
    ...
    values={[
        ...
        { label: 'stop_all_services', value: 'stop_all_services' }
    ]}
>
...
<TabItem value="stop_all_services">
