...
Creates, updates, deletes, gets or lists a <code>role_future_grants</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="role_future_grants" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="snowflake.roles.role_future_grants" /></td></tr>
</tbody></table>
...
securable,
securable_type
FROM snowflake.roles.role_future_grants
...
```sql
INSERT INTO snowflake.roles.role_future_grants (
securable,
containing_scope,
securable_type,
grant_option,
...
- name: role_future_grants
  props:
    - name: name
      value: "{{ name }}"
      description: Required parameter for the role_future_grants resource.
    - name: endpoint
      value: "{{ endpoint }}"
      description: Required parameter for the role_future_grants resource.
    - name: securable
...
```sql
EXEC snowflake.roles.role_future_grants.revoke 
@name='{{ name }}' --required, 
