...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="image_repositories" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="snowflake.apps.image_repositories" /></td></tr>
</tbody></table>
...
owner_role_type,
repository_url
FROM snowflake.apps.image_repositories
...
```sql
INSERT INTO snowflake.apps.image_repositories (
name,
database_name,
schema_name,
endpoint,
...
```sql
DELETE FROM snowflake.apps.image_repositories
WHERE database_name = '{{ database_name }}' --required
AND schema_name = '{{ schema_name }}' --required
AND name = '{{ name }}' --required
AND endpoint = '{{ endpoint }}' --required
