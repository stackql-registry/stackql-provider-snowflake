...
<tr><td><b>Id</b></td><td><CopyableCode code="snowflake.apps.services" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-database_name"><code>database_name</code></a>, <a href="#parameter-schema_name"><code>schema_name</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-compute_pool"><code>compute_pool</code></a>, <a href="#parameter-spec"><code>spec</code></a></td>
...
<tr>
    <td><a href="#execute_job"><CopyableCode code="execute_job" /></a></td>
...
```sql
INSERT INTO snowflake.apps.services (
name,
status,
compute_pool,
spec,
...
```sql
REPLACE snowflake.apps.services
SET 
name = '{{ name }}',
status = '{{ status }}',
...
```sql
DELETE FROM snowflake.apps.services
WHERE database_name = '{{ database_name }}' --required
AND schema_name = '{{ schema_name }}' --required
AND name = '{{ name }}' --required
AND endpoint = '{{ endpoint }}' --required
...
<Tabs
    defaultValue="execute_job"
    values={[
        { label: 'execute_job', value: 'execute_job' },
        { label: 'resume', value: 'resume' },
        { label: 'suspend', value: 'suspend' }
    ]}
>
<TabItem value="execute_job">
...
```sql
EXEC snowflake.apps.services.execute_job 
@database_name='{{ database_name }}' --required, 
...
```sql
EXEC snowflake.apps.services.resume 
@database_name='{{ database_name }}' --required, 
@schema_name='{{ schema_name }}' --required, 
@name='{{ name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC snowflake.apps.services.suspend 
@database_name='{{ database_name }}' --required, 
@schema_name='{{ schema_name }}' --required, 
@name='{{ name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
