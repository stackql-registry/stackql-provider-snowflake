...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="notification_integrations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="snowflake.integrations.notification_integrations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Name of the notification. (pattern: <code>^"(&#91;^"&#93;|"")+"|&#91;a-zA-Z_&#93;&#91;a-zA-Z0-9_$&#93;*$</code>)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-endpoint"><code>endpoint</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-notification_hook"><code>notification_hook</code></a></td>
...
enabled,
notification_hook
FROM snowflake.integrations.notification_integrations
...
```sql
INSERT INTO snowflake.integrations.notification_integrations (
name,
enabled,
comment,
notification_hook,
...
```sql
DELETE FROM snowflake.integrations.notification_integrations
WHERE name = '{{ name }}' --required
AND endpoint = '{{ endpoint }}' --required
