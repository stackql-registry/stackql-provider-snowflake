...
Creates, updates, deletes, gets or lists an <code>analyst_feedback</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="analyst_feedback" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="snowflake.cortex.analyst_feedback" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-endpoint"><code>endpoint</code></a>, <a href="#parameter-request_id"><code>request_id</code></a>, <a href="#parameter-positive"><code>positive</code></a></td>
    <td></td>
...
- name: analyst_feedback
  props:
    - name: endpoint
      value: "{{ endpoint }}"
      description: Required parameter for the analyst_feedback resource.
    - name: request_id
      value: "{{ request_id }}"
      description: |
