...
<tr>
    ...
    <td><code>string</code></td>
    <td>Snowflake Edition of the account. Possible values to use when creating an account include STANDARD, ENTERPRISE, and BUSINESS_CRITICAL.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-endpoint"><code>endpoint</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-admin_name"><code>admin_name</code></a>, <a href="#parameter-email"><code>email</code></a>, <a href="#parameter-edition"><code>edition</code></a></td>
    <td></td>
...
```sql
EXEC snowflake.account.accounts.undrop 
@name='{{ name }}' --required, 
