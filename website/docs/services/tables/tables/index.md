...
<tr><td><b>Id</b></td><td><CopyableCode code="snowflake.tables.tables" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Table type - permanent, transient, or temporary (PERMANENT, TRANSIENT, TEMPORARY, , transient, temporary) (default: PERMANENT)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Type of the table (NORMAL, DYNAMIC, EXTERNAL, EVENT, HYBRID, ICEBERG, IMMUTABLE)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td><a href="#parameter-database_name"><code>database_name</code></a>, <a href="#parameter-schema_name"><code>schema_name</code></a>, <a href="#parameter-table_name"><code>table_name</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a>, <a href="#parameter-name"><code>name</code></a></td>
    <td></td>
...
<tr>
    <td><a href="#using_template"><CopyableCode code="using_template" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-database_name"><code>database_name</code></a>, <a href="#parameter-schema_name"><code>schema_name</code></a>, <a href="#parameter-query"><code>query</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a></td>
    <td><a href="#parameter-createMode"><code>createMode</code></a>, <a href="#parameter-copyGrants"><code>copyGrants</code></a></td>
...
<tr>
    <td><a href="#swap_with"><CopyableCode code="swap_with" /></a></td>
    <td><CopyableCode code="exec" /></td>
...
```sql
INSERT INTO snowflake.tables.tables (
name,
kind,
cluster_by,
enable_schema_evolution,
    ...
    - name: columns
      value:
        - name: "{{ name }}"
          ...
          autoincrement_start: {{ autoincrement_start }}
          autoincrement_increment: {{ autoincrement_increment }}
...
```sql
REPLACE snowflake.tables.tables
SET 
name = '{{ name }}',
kind = '{{ kind }}',
...
```sql
DELETE FROM snowflake.tables.tables
WHERE database_name = '{{ database_name }}' --required
AND schema_name = '{{ schema_name }}' --required
AND name = '{{ name }}' --required
AND endpoint = '{{ endpoint }}' --required
...
<Tabs
    ...
    values={[
        ...
        { label: 'using_template', value: 'using_template' },
        ...
        { label: 'swap_with', value: 'swap_with' }
    ]}
>
...
```sql
EXEC snowflake.tables.tables.as_select 
@database_name='{{ database_name }}' --required, 
...
<TabItem value="using_template">

Create a table using template.

```sql
EXEC snowflake.tables.tables.using_template 
@database_name='{{ database_name }}' --required, 
@schema_name='{{ schema_name }}' --required, 
@query='{{ query }}' --required, 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC snowflake.tables.tables.clone 
@database_name='{{ database_name }}' --required, 
@schema_name='{{ schema_name }}' --required, 
@name='{{ name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC snowflake.tables.tables.create_like 
@database_name='{{ database_name }}' --required, 
@schema_name='{{ schema_name }}' --required, 
@name='{{ name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC snowflake.tables.tables.undrop 
@database_name='{{ database_name }}' --required, 
@schema_name='{{ schema_name }}' --required, 
@name='{{ name }}' --required, 
@endpoint='{{ endpoint }}' --required
...
```sql
EXEC snowflake.tables.tables.suspend_recluster 
@database_name='{{ database_name }}' --required, 
@schema_name='{{ schema_name }}' --required, 
@name='{{ name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
...
```sql
EXEC snowflake.tables.tables.resume_recluster 
@database_name='{{ database_name }}' --required, 
@schema_name='{{ schema_name }}' --required, 
@name='{{ name }}' --required, 
@endpoint='{{ endpoint }}' --required, 
...
<TabItem value="swap_with">

Swap with another table

```sql
EXEC snowflake.tables.tables.swap_with 
@database_name='{{ database_name }}' --required, 
@schema_name='{{ schema_name }}' --required, 
@name='{{ name }}' --required, 
