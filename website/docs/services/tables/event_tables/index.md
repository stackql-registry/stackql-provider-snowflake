...
## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="event_tables" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="snowflake.tables.event_tables" /></td></tr>
</tbody></table>
...
FROM snowflake.tables.event_tables
...
```sql
INSERT INTO snowflake.tables.event_tables (
name,
cluster_by,
data_retention_time_in_days,
max_data_extension_time_in_days,
...
```sql
DELETE FROM snowflake.tables.event_tables
WHERE database_name = '{{ database_name }}' --required
AND schema_name = '{{ schema_name }}' --required
AND name = '{{ name }}' --required
AND endpoint = '{{ endpoint }}' --required
...
```sql
EXEC snowflake.tables.event_tables.rename 
