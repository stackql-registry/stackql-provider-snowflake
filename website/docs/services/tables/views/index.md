...
<tr><td><b>Id</b></td><td><CopyableCode code="snowflake.tables.views" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>Kind of the view, permanent (default) or temporary (PERMANENT, TEMPORARY)</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-database_name"><code>database_name</code></a>, <a href="#parameter-schema_name"><code>schema_name</code></a>, <a href="#parameter-endpoint"><code>endpoint</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-columns"><code>columns</code></a>, <a href="#parameter-query"><code>query</code></a></td>
...
```sql
INSERT INTO snowflake.tables.views (
name,
secure,
kind,
"recursive",
...
```sql
DELETE FROM snowflake.tables.views
WHERE database_name = '{{ database_name }}' --required
AND schema_name = '{{ schema_name }}' --required
AND name = '{{ name }}' --required
AND endpoint = '{{ endpoint }}' --required
